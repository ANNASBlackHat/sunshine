 ...
 * This extends AbstractAccountAuthenticator.
 * This code manages authenticating with Sunshine’s background service (as in Open Weather Map).
 * Since Open Weather Map needs no authentication,
 * this is literally the stub code from the Developer Guide on sync adapters.
